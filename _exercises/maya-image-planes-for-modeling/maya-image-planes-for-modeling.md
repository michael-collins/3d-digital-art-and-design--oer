...
3) After you have completed the tutorial, double-click on your _ex_1_xyz.zip_ file to ensure that it looks like this: ![Example folder structure]({{ site.baseurl  }}/{{page.url | replace:'.html','/'}}/images/image_0.jpg)
